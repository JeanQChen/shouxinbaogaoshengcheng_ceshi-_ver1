...
ACCOUNTS_RECEIVABLE_COMBINED = "应收票据及应收账款"  # 2018 新准则合并列示
INVENTORY = "存货"
...
FAIR_VALUE_CHANGE_GAINS = "公允价值变动收益"
...
COMPREHENSIVE_INCOME_PARENT = "归属于母公司所有者的综合收益总额"
COMPREHENSIVE_INCOME_MINORITY = "归属于少数股东的综合收益总额"
CONTINUING_OP_NET_PROFIT = "持续经营净利润"
EPS = "每股收益"
EPS_BASIC = "每股收益-基本"
EPS_DILUTED = "每股收益-稀释"
...
FINANCIAL_ASSET_TERMINATION_INCOME = "以摊余成本计量的金融资产终止确认收益"
...
SUBTOTAL_OPERATING_CASH_INFLOW = "经营活动现金流入小计"
CASH_PAID_FOR_GOODS = "购买商品、接受劳务支付的现金"
CASH_PAID_TO_EMPLOYEES = "支付给职工以及为职工支付的现金"
TAXES_PAID = "支付的各项税费"
OTHER_OPERATING_CASH_PAID = "支付其他与经营活动有关的现金"
SUBTOTAL_OPERATING_CASH_OUTFLOW = "经营活动现金流出小计"

# ── 现金流量表 - 投资活动 ──
CASH_RECEIVED_FROM_INVESTMENT_RETURN = "收回投资收到的现金"
CASH_RECEIVED_FROM_INVESTMENT_INCOME = "取得投资收益收到的现金"
CASH_RECEIVED_FROM_DISPOSAL = "处置子公司及其他营业单位收到的现金净额"
OTHER_INVESTING_CASH_RECEIVED = "收到其他与投资活动有关的现金"
SUBTOTAL_INVESTING_CASH_INFLOW = "投资活动现金流入小计"
CASH_PAID_FOR_INVESTMENT = "投资支付的现金"
CASH_PAID_FOR_ACQUISITION = "取得子公司及其他营业单位支付的现金净额"
OTHER_INVESTING_CASH_PAID = "支付其他与投资活动有关的现金"
SUBTOTAL_INVESTING_CASH_OUTFLOW = "投资活动现金流出小计"

# ── 现金流量表 - 筹资活动 ──
CASH_RECEIVED_FROM_CAPITAL = "吸收投资收到的现金"
CASH_RECEIVED_MINORITY_INVESTMENT = "子公司吸收少数股东投资收到的现金"
CASH_RECEIVED_FROM_BORROWINGS = "取得借款收到的现金"
CASH_RECEIVED_FROM_BOND_ISSUANCE = "发行债券收到的现金"
OTHER_FINANCING_CASH_RECEIVED = "收到其他与筹资活动有关的现金"
SUBTOTAL_FINANCING_CASH_INFLOW = "筹资活动现金流入小计"
CASH_PAID_FOR_DEBT = "偿还债务支付的现金"
CASH_PAID_FOR_DIVIDEND_INTEREST = "分配股利、利润或偿付利息支付的现金"
CASH_PAID_MINORITY_DIVIDEND = "子公司支付给少数股东的股利、利润"
OTHER_FINANCING_CASH_PAID = "支付其他与筹资活动有关的现金"
SUBTOTAL_FINANCING_CASH_OUTFLOW = "筹资活动现金流出小计"
...
# ── 现金流量表 - 简称变体（不同公司可能省略"产生的"）──
OPERATING_CASH_FLOW_SHORT = "经营活动现金流量净额"
INVESTING_CASH_FLOW_SHORT = "投资活动现金流量净额"
FINANCING_CASH_FLOW_SHORT = "筹资活动现金流量净额"
CASH_AND_EQUIVALENTS_CF = "现金及现金等价物"  # 附注中的验证行
