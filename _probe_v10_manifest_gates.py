"""只读取证：v10 manifest 的关闭条件逐条 satisfied / 明细（§八 条件 3/6/7 与 A–D）。"""
...
MANIFEST = Path("evaluation/results/r2_six_category_acceptance_v10_20260916/"
                "six_category_manifest.json")


def _dump(name: str, node: object, limit: int = 2000) -> None:
    print("=" * 78)
